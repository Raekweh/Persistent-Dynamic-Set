...
public class BinarySearchTree<E> extends AbstractSet<E> implements SortedSet<E> {
    ...
    protected ArrayList<BinaryTreeNode> nodesVisted;

    public void hookAddMethod(BinaryTreeNode node) {
    }

    public void hookRemoveMethod(BinaryTreeNode nodes) {
    }
    ...
    // specified view
    protected boolean withinView(E element) {
        boolean inside = true;
